...
- `USER_PROFILE.md` — short public-safe profile.
- `MOTIVATION_STYLE.md` — language rules for motivational messages.
- `CURRENT_FOCUS.md` — current weekly focus and next actions.
...
Do not infer diagnoses. Do not give medical prescriptions. Do not motivate through fear. Do not compare Yuriy to other people.
